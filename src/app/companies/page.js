    ...
    <div className="container animate-fade-in-up" style={{ padding: '2rem 0' }}>
      ...
      >
        <div>
          ...
          <h1 style={{ marginBottom: '0.25rem' }}>Companies & credit control</h1>
          <p className="page-subtitle">
            Create companies, adjust credit limits and jump directly into a company’s live
            dashboard.
          </p>
        </div>
        <button
          ...
          className="btn"
          style={{ border: '1px solid var(--border)', paddingInline: '1.1rem' }}
        >
          Logout admin
        </button>
      </header>
      ...
      <div style={{ display: 'grid', gap: '2rem', gridTemplateColumns: 'minmax(300px, 1fr) 2fr' }}>
        ...
        <section className="card animate-fade-in-up delay-100">
          ...
          <p className="page-subtitle" style={{ marginBottom: '1.5rem' }}>
            Spin up a test account to explore how credit limits, debt and product pricing behave.
          </p>
          <form
        ...
        <section className="card animate-fade-in-up delay-200">
          ...
          >
             {loading ? (
               ...
               <div
                 key={company.id}
                 className={`row-hover animate-fade-in-up delay-${Math.min(
                   (index + 3) * 100,
                   500
                 )}`}
                 style={{
               ...
               >
                 ...
                 >
                   ...
                   >
                     <span style={{ opacity: 0.8 }}>Credit</span>
                     {editingId === company.id ? (
                       ...
                       >
                         ...
                         />
                         <button
                           onClick={(e) => handleUpdateLimit(company.id, e)}
                           className="btn btn-primary"
                       ...
                       >
                         <span>₹{company.credit_limit.toLocaleString()}</span>
                         <button
                           onClick={(e) => startEditing(company, e)}
                           style={{
                             background: 'none',
                             border: 'none',
                             color: 'var(--primary)',
                     ...
                     <span>
                       Debt:{' '}
                       <span
                         className={company.current_debt > 0 ? 'text-error' : ''}
                       >
                         ₹{company.current_debt.toLocaleString()}
                       </span>
                     </span>
                   </div>
                 </div>
                 <div style={{ marginLeft: '1rem' }}>
                   {confirmDeleteId === company.id ? (
                     <div
                       ...
                       onClick={(e) => e.stopPropagation()}
                     >
                       <span className="text-error" style={{ fontSize: '0.8rem' }}>
                         Are you sure?
                       </span>
                       <button
                         onClick={(e) => {
